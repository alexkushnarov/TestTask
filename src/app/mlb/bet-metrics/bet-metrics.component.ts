...
export class BetMetricsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.model = null;
    this.outcome = null;
    this.win_prob_max = null;
    this.win_prob_min = null;
    this.ev_max = null;
    this.ev_min = 0
    this.scale = true;
    this.betMetricsService.mlbBetMetrics(this.bet_type, this.model, this.outcome, this.win_prob_max, this.win_prob_min, this.ev_max, this.ev_min, this.scale)
